...
public class StudentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listItem.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                //Todo: get current student from StudentList based on position then past student as Intent Extra DONE
    ...
    public void onResume(){
        super.onResume();
        //Todo: Refresh list post add or edit student DONE
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch(item.getItemId()){
            case R.id.createDummyItem:
                ...
                StudentList dummy = populateStudentDummies();
                studentArrayAdapter = new StudentArrayAdapter(this, dummy);
                listItem.setAdapter(studentArrayAdapter);
                Student.setStudentList(dummy);
